# Support for Output Descriptors in afrikacoin Core

Since afrikacoin Core v0.17, there is support for Output Descriptors in the
...
on afrikacoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing afrikacoin Core wallets, a convenience function `combo` is
